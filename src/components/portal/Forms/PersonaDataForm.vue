...
<template>
    <form @click="mostre" class="shadow-xl w-3/5 mx-auto bg-white px-20 py-8 flex flex-col items-center border mt-14 rounded-lg lg:w-5/6 sm:w-full md:px-10">
        ...
        <div v-for="(field, id) in PersonaDataGeneric" :key="id" class="relative p-0 pt-3 mt-5 w-full">
            ...
            <input type="text" class="border-2 rounded-md w-full h-10" v-model="PersonaDataGeneric[id]" >
        </div>
        ...
        <div class="relative p-0 pt-3 mt-5 w-full">
            ...
            <select class="border-2 rounded-md w-full h-10 bg-white cursor-pointer appearance-none" >
