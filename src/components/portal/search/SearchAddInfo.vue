<script setup>
import { BtnDefault, BtnStroke, ContainerGlobal } from '@/components';
import { useAuthStore } from '@/stores';
const authStore = useAuthStore()
</script>

<template>
   <ContainerGlobal class="mt-28">
       <h3 class="text-2xl font-medium font-poppins">Não Achou oque procurava?</h3>
      ...
      <div class="flex justify-end gap-10 mt-5 flex-wrap">
         ...
         <BtnDefault v-if="!authStore.userInfo.is_verified"link="/portal/personal-data" :text="'Ser um Colaborador'" :color="'text-white'" :background="'bg-black'" class="hover:invert-14 " />
      </div>
   </ContainerGlobal>
</template>