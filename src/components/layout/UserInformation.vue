...
<template>
    <div :class='`min-w-[240px] max-w-[420px] over z-40 ${props.position} right-0 my-4 mr-8 cursor-pointer flex flex-col items-center gap-4 rounded-md justify-between container-information `'>
